async function getGroupWindow(groupName) {
    try {
        ...
        console.error(console.error(`failed getting group window for ${groupName}, error message: ${err.message}`))
    }
}
...
async function getCreateGroupWindow() {
    try {
        ...
        console.error(console.error(`failed getting group creation window, error message: ${err.message}`))
    }
}
